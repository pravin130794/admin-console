...
from app.models import User, Group, Project, UserToken, UserOTP, Devices, Host  # Import models
...
async def init_db():
    ...
    await init_beanie(
        ...
        document_models=[User, Group, Project, UserToken, UserOTP, Devices, Host]
    )
